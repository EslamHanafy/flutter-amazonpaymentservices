...
public class FlutterAmazonpaymentservicesPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    // Deprecated v1 embedding registerWith method removed for compatibility with new Android Gradle plugin
    // The plugin now uses v2 embedding (FlutterPlugin + ActivityAware)
